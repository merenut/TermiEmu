# Terminal Emulator Feature Matrix

**Comprehensive Feature Comparison Across 14 Major Terminal Emulators**

Legend:
- ✅ **Full Support**: Feature fully implemented and mature
- ⚡ **Advanced**: Best-in-class implementation with extensions
- 🔶 **Partial**: Basic implementation or limited support
- ❌ **No Support**: Feature not available
- 🚧 **In Progress**: Feature under development
- 📦 **Plugin**: Available via plugin/extension
...
| Tabby | Win/Mac/Linux | 🔶 Web | YAML/JSON | ⚡ TypeScript | ✅ SSH/Serial | 🔶 | ❌ |
| Terminator | Linux | ❌ VTE | Config | 📦 | ⚡ Tiling | 🔶 | ❌ |
| Tilix | Linux | ❌ VTE | dconf | ❌ | ⚡ Tiling | 🔶 | ❌ |
